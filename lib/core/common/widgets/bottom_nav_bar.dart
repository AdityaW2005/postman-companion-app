        ...
        bottomNavigationBar: BottomNavigationBar(
          ...
          items: [
            BottomNavigationBarItem(
              ...
              activeIcon: _buildActiveIcon(Iconsax.home_copy, 0),
              label: "Home",
            ),
            BottomNavigationBarItem(
              icon: _buildNavIcon(Iconsax.calendar, 1),
              activeIcon: _buildActiveIcon(Iconsax.box_1_copy, 1),
              label: "Timetable",
            ),
            BottomNavigationBarItem(
              icon: _buildNavIcon(Iconsax.document, 2),
              activeIcon: _buildActiveIcon(Iconsax.message_copy, 2),
              label: "Attendance",
            ),
            BottomNavigationBarItem(
              icon: _buildNavIcon(Iconsax.user, 3),
              activeIcon: _buildActiveIcon(Iconsax.setting_copy, 3),
              label: "Account",
            ),
          ],
